...
func NewTerminal(p *conpty.ConPty) *Terminal {
...
func (t *Terminal) Blink() {
	...
	for {
		...
		if blink {
			...
			t.ui.SetCell(t.row, t.col+t.cursor, widget.TextGridCell{Style: &widget.CustomTextGridStyle{BGColor: theme.Color(theme.ColorNameBackground)}})
		}
		blink = !blink
	}
}
...
func (t *Terminal) TypedKey(e *fyne.KeyEvent) {
	...
	case fyne.KeyEnter, fyne.KeyReturn:
		_, _ = t.pty.Write([]byte(string(t.commandBuffer)))
		t.commandBuffer = nil
